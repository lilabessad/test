...
CAT_LIB_PATH=../../RobotArmLib
CAT_LIB_PATH_OTHERS= $(CAT_LIB_PATH)/RobotArmBase $(CAT_LIB_PATH)/RobotArmI2C
...
SRC += $(CAT_LIB_PATH)/RobotArmBase/RobotArmBaseLib.c
SRC += $(CAT_LIB_PATH)/RobotArmBase/RobotArmUart.c
...
EXTRAINCDIRS = $(CAT_LIB_PATH) $(CAT_LIB_PATH_OTHERS)
